 ...
 console.log(email_lista)
  ...
  const remove_elligibility = (id) =>{
    ...
    const send_gmail=(e)=>{
        ...
        emailjs.sendForm('service_re3j227','template_gsqdum4',e.target,'pi6zBECU2k6EEbW_I').then(res=>{console.log(res);}).catch(err=>{console.log(err);});
    ...
    <form className="d-flex">
      ...
      <div>
        ...
        <div className="mb-3">
          ...
          <input type="text" name="from" className="form-control" id="exampleInputPassword1" />
        </div>
        <div className="mb-3">
          <label htmlFor="exampleInputPassword1" className="form-label">To</label>
          <input type="text" name="to" className="form-control" id="exampleInputPassword1" />
        </div>
        <div className="mb-3">
